...
const productItems: ProductMenuItem[] = [
  ...
  },
  {
    ...
    description: 'Digitize your consultation forms, consent forms, and treatment records.',
    icon: FileText,
    image: 'https://images.unsplash.com/photo-1554224155-6726b3ff858f?auto=format&fit=crop&w=1200&h=800&q=80'
  },
  {
    title: 'AI Assistant',
    ...
    <div className="absolute top-full left-0 pt-4 w-[600px]">
      <div className="bg-white rounded-xl shadow-lg ring-1 ring-black/5 overflow-hidden">
        ...
        <div className="p-6 border-b border-gray-100">
          <h2 className="text-lg font-semibold text-gray-900">Customer Service Software</h2>
